...
public class AssignmentTask4{
    ...
    public static Node idGenerator(Node head1, Node head2, Node head3) {
        ...
        while(temp1!=null&&temp2!=null){
            ...
            int i =(int) temp1.elem;
            int j = (int) temp2.elem;
            int sum= i+j;
            if (i+j>=10){
                sum=sum%10;
            }
        ...
        return mainHead; // Remove this when you're ready to return the new head
    }
